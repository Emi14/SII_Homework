...
import static org.siit.homework.week7.student.studentRepository.StudentRepository.*;

public abstract class MainMenu {

    public static String operationChoice;
    public static Logger logger = Logger.getLogger(MainMenu.class.getName());
    ...
    public static void choice1(Set<Student> studentSet, Scanner scanner) {
        ...
        } catch (EmptyVariableException | InvalidInputFormatException | OutOfMemoryException e) {
            logger.log(Level.SEVERE, e.getMessage(), e.getCause());
            System.out.println(e.getMessage());
            System.out.println("Please try again");
    ...
    public static void printMainMenu() {
        System.out.println("Welcome to StudentdRepository!");
        System.out.println("You can choose from the following operations by typing the number:");
        System.out.println("1 - To add a student to the repository");
        System.out.println("2 - To delete a student from the repository");
        System.out.println("3 - To retrieve all students that meet the age criteria");
        System.out.println("4 - To list all the students from the repository");
