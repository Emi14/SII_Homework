...
public class PersonProcessor {
    public void processData(String inputFileName, int month, String outputFileName) {
        List<Person> aList = readFile(inputFileName);

        List<Person> processedList = aList.stream()
        ...
        writeFile(processedList, outputFileName);
    }
